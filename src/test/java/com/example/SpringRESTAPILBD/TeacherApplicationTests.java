...
//        mockMvc.perform(MockMvcRequestBuilders.get("/api/teacher/all").header("role", "TEACHER_ROLE"))
...
//        mockMvc.perform(MockMvcRequestBuilders.get("/api/teacher/2").header("role", "TEACHER_ROLE"))
//                .andExpect(status().isOk())
//                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
...
//                        .post("/api/teacher").header("role", "TEACHER_ROLE")
...
//    {
//        mockMvc.perform(MockMvcRequestBuilders.delete("/api/teacher/{id}", 1).header("role", "TEACHER_ROLE"))
//                .andExpect(status().isOk());
//    }
//
//    @Test
...
//    {
//        mockMvc.perform(MockMvcRequestBuilders.delete("/api/teacher/{teacherId}/class/{studentId}", 1, 1).header("role", "TEACHER_ROLE"))
//                .andExpect(status().isOk())
//                .andDo(print());
//    }
//}
